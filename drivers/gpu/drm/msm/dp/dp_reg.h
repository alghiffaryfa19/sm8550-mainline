...
#define DP_MAINLINK_CTRL_FEC_SEQ_EN		BIT(22)
#define DP_MAINLINK_CTRL_FEC_FLUSH_EN		GENMASK(24, 23)
...
#define DP_PPS_FLUSH				BIT(0)
#define DP_DSC_DTO_ENABLE			BIT(0)
#define DP_DSC_DTO_ACK				BIT(1)
